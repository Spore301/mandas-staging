...
?>><?php
	...
	?><div class="sc_form_field_wrap"><?php
		...
		// Filter items
		if ( isset( $args['field_options'] ) && is_array( $args['field_options'] ) && count( $args['field_options'] ) >= apply_filters( 'trx_addons_filters_woocommerce_search_show_filter_items_threshold', 15 ) ) {
			?>
			<div class="sc_form_field_items_filter">
				<input type="text" class="sc_form_field_items_filter_text" placeholder="<?php esc_attr_e( 'Type to filter items...', 'trx_addons' ); ?>" />
			</div>
			<?php
		}
