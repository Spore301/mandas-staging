...
if ( ! function_exists( 'trx_addons_theme_specific_add_page_content_wrap_custom_header_margin' ) ) {
	add_filter( 'trx_addons_filter_inline_css', 'trx_addons_theme_specific_add_page_content_wrap_custom_header_margin' );
	/**
	 * Add class 'page_content_wrap_custom_header_margin' to the rules with paddings of content to increase weight of these rules
	 * 
	 * @hooked 'trx_addons_filter_inline_css'
	 * 
	 * @param string $css  Inline CSS
	 * 
	 * @return string 		Modified inline CSS
	 */
	function trx_addons_theme_specific_add_page_content_wrap_custom_header_margin( $css ) {
		return str_replace( '.page_content_wrap{padding-', '.page_content_wrap.page_content_wrap_custom_header_margin{padding-', $css );
	}
}
