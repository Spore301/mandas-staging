...
if ( ! function_exists( 'literature_gutenberg_get_css' ) ) {
	add_filter( 'literature_filter_get_css', 'literature_gutenberg_get_css', 10, 2 );
	function literature_gutenberg_get_css( $css, $args ) {
